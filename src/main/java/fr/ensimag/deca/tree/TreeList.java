...
public abstract class TreeList<TreeType extends Tree> extends Tree {
    ...
    public void addList(TreeList<TreeType> list2) {
        for(TreeType x : list2.getList()) {
            this.add(x);
        }
    }
    ...
    /**
     * Implementation of the method describe in the previous method description
     * @author H
     * @return
     */
    public ArrayList<TreeType> getModifiableList() {
        return (ArrayList<TreeType>)list;
    }
